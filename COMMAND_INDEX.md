...
- `/펫무쌍시작`은 참가자·전투 스냅샷을 확정한 뒤 30초 준비 유예를 저장하고, 준비 중 공격을 차단한 다음 유예 종료 시 첫 공격자의 15초 타이머를 시작한다. 시작 준비 안내, 진행 중 제한 안내, 준비 종료 NoticeMsg는 출력하지 않는다.
...
- 보상 대상 공격 1회당 기본 3억, 최종 점령자 우승 상금 30억을 지급한다. 우승 확정 메시지는 `NoticeMsg`로 방송하지 않는다.
