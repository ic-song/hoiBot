...
DELETE FROM item_definitions WHERE item_id = 'ITEM-RWD-012';
...
DELETE FROM item_definitions WHERE item_id = 'ITEM-RWD-013';
...
DELETE FROM item_definitions WHERE item_id = 'ITEM-RWD-050';
...
DELETE FROM item_definitions WHERE item_id = 'ITEM-RWD-051';
...
DELETE FROM item_definitions WHERE item_id = 'ITEM-RWD-046';
