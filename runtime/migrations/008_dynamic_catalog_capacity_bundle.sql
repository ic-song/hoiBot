...
CREATE TABLE package_reward_bundle_items (
  ...
  CONSTRAINT fk_package_reward_bundle_item FOREIGN KEY (item_id) REFERENCES item_definitions(item_id),
...
CREATE TABLE dynamic_item_catalog_entries (
  ...
  CONSTRAINT fk_dynamic_catalog_item FOREIGN KEY (item_id) REFERENCES item_definitions(item_id),
