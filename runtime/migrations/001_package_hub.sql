...
CREATE TABLE IF NOT EXISTS item_balances (
  ...
  CONSTRAINT fk_item_balance_definition FOREIGN KEY (item_id) REFERENCES item_definitions(item_id),
...
CREATE TABLE IF NOT EXISTS item_instances (
  ...
  CONSTRAINT fk_item_instance_definition FOREIGN KEY (item_id) REFERENCES item_definitions(item_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS package_catalog (
  ...
  CONSTRAINT fk_package_consume_item FOREIGN KEY (consume_item_id) REFERENCES item_definitions(item_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS package_rewards (
  ...
  CONSTRAINT fk_package_reward_item FOREIGN KEY (item_id) REFERENCES item_definitions(item_id),
...
CREATE TABLE IF NOT EXISTS item_ledger (
  ...
  KEY ix_item_ledger_operation (operation_id),
  CONSTRAINT fk_item_ledger_definition FOREIGN KEY (item_id) REFERENCES item_definitions(item_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
