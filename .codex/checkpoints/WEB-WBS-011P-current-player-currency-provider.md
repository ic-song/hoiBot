...
- State: Gate 1~7 complete, independent Gate 7 GO (P0=0/P1=0/P2=2), Gate 8 false
...
Independent validation passed focused 13/13, broader admin/profile/auth 49/49, typecheck, build, diff-check, and hashes 3/3. The remaining P2 observations are the absence of a live MariaDB inactive-row precision probe and the now-corrected stale CONTROL pointer.

Next: integrate this provider Lease and start the Medium `/account/currencies` UI consumer Lease.
