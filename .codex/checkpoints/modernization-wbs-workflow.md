...
- 마지막 푸시 커밋: 반영 전
- 원격 동기화 상태: 작업 전 `feature/prod` 최신 반영 및 `feature/workflow` 병합 완료
- 체크포인트 Git 추적: 커밋 예정
- 체크포인트 포함 푸시 커밋:
...
1. `feature/workflow`에 커밋·푸시하고 해당 문서 커밋만 `feature/prod`에 반영한다.
