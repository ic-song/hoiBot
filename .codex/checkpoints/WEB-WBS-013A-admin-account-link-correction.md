...
- W resources: read service, focused test, `web-admin-account-link-correction-20260910` evidence, this canonical checkpoint only.
- R resources: read route and current admin web shell route/assets/tests.
- Gate 1~6: correction evidence PASS; see `validation.md`, `summary.json`, and `raw-results.json` in the correction evidence directory.
