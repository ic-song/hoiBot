...
- esbuild parsed the assets, route registrar, and test bundle successfully; the three focused Fastify/security/accessibility/API-contract tests pass.
