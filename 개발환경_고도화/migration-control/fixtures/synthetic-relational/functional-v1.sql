...
INSERT INTO item_definitions (id, code, display_name, asset_type_code, stackable, metadata_json, active, version) VALUES
  ...
  (910000020, 'bag_9b3e69dbd2e91260', '정령조각🥀', 'material', TRUE, JSON_OBJECT('synthetic', TRUE, 'legacyBagName', '정령조각🥀'), TRUE, 1),
  (910000021, 'bag_55b34cbde0088b29', '정령 강화석🥀', 'consumable', TRUE, JSON_OBJECT('synthetic', TRUE, 'legacyBagName', '정령 강화석🥀'), TRUE, 1)
