...
- 선행 의존은 `444_canonical_item_inventory.sql:canonical_players`, `446_canonical_pet_equipment.sql:canonical_owned_pet_instances`로 정확히 고정했다.
...
- grant/equip은 transaction, row lock, 업무 UNIQUE 재시작, exact replay, payload conflict 검증을 포함한다.
