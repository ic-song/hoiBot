...
describe("object DB executable parity Wave1 title list-owned cohort", () => {
  it("promotes only the exact three source-derived consumers with a complete five-scenario matrix", () => {
    ...
    assert.deepEqual(ledger.coverage, {
      ...
      provenConsumers: 14, unprovenConsumers: 1097, directPassConsumers: 14, equivalentPassConsumers: 0,
      verdicts: { STATIC_ONLY: 545, BLOCKED_DYNAMIC: 552, BLOCKED_REGISTRY_MISMATCH: 0, PARTIAL: 0, DIRECT_PASS: 14, EQUIVALENT_PASS: 0 },
    });
