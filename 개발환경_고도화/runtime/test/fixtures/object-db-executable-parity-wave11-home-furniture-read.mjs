...
export async function executeWave11HomeFurnitureRead(args){
 ...
 args.database.withTransaction=async(work)=>{const state={...evidenceRows};try{return await originalWithTransaction(transaction=>work(transaction));}catch(error){Object.assign(evidenceRows,state);throw error;}};
