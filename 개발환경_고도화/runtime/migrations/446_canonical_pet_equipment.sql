...
-- Requires 444_canonical_item_inventory.sql for canonical_item_players(player_id).
...
CREATE TABLE canonical_owned_pet_instances (
  ...
  CONSTRAINT fk_canonical_owned_pet_player FOREIGN KEY (player_id) REFERENCES canonical_item_players (player_id) ON DELETE RESTRICT,
...
CREATE TABLE canonical_owned_equipment_instances (
  ...
  CONSTRAINT fk_canonical_owned_equipment_player FOREIGN KEY (player_id) REFERENCES canonical_item_players (player_id) ON DELETE RESTRICT,
...
CREATE TABLE canonical_owned_pet_equipment (
  ...
  CONSTRAINT fk_canonical_owned_pet_equipment_pet FOREIGN KEY (owned_pet_id) REFERENCES canonical_owned_pet_instances (owned_pet_id) ON DELETE RESTRICT,
  CONSTRAINT fk_canonical_owned_pet_equipment_equipment FOREIGN KEY (owned_equipment_id) REFERENCES canonical_owned_equipment_instances (owned_equipment_id) ON DELETE RESTRICT,
...
CREATE TABLE canonical_pet_equipment_operation_replays (
  ...
  CONSTRAINT fk_canonical_pet_equipment_operation_player FOREIGN KEY (player_id) REFERENCES canonical_item_players (player_id) ON DELETE RESTRICT,
  CONSTRAINT fk_canonical_pet_equipment_operation_assignment FOREIGN KEY (owned_pet_equipment_id) REFERENCES canonical_owned_pet_equipment (owned_pet_equipment_id) ON DELETE RESTRICT,
