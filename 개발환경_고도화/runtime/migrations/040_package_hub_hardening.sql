...
CREATE INDEX IF NOT EXISTS ix_item_instance_target_active
  ON package_item_instances(owner_type, owner_id, target_instance_id, removed_at);

ALTER TABLE package_item_instances
  ADD CONSTRAINT fk_item_instance_target
  FOREIGN KEY (target_instance_id) REFERENCES package_item_instances(instance_id);
