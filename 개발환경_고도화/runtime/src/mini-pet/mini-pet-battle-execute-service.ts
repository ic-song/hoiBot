...
export class MiniPetBattleExecuteService{
  ...
  async handle(command:{externalUserId:string;channelId:string;message:string;eventId:string;mode?:"direct"|"auto";suppressOutbox?:boolean}):Promise<MiniPetBattleExecuteResult>{
