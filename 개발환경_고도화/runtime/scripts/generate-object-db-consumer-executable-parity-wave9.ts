...
const fixturePath = "개발환경_고도화/migration-control/fixtures/synthetic-relational/object-db-consumer-executable-parity-wave9-rank-chain-v1.json";
const harnessPath = "개발환경_고도화/runtime/test/fixtures/object-db-executable-parity-wave9-harness.mjs";
const targetPath = "개발환경_고도화/runtime/test/fixtures/object-db-executable-parity-wave9-rank-chain.mjs";
const outputPath = "개발환경_고도화/migration-control/fixtures/synthetic-relational/object-db-consumer-execution-receipts-wave9-v1.json";
const fixture = JSON.parse(read(fixturePath));
const prior = JSON.parse(read("개발환경_고도화/migration-control/fixtures/synthetic-relational/object-db-consumer-execution-receipts-wave8-v1.json"));
...
for (const binding of fixture.bindings) {
  ...
  try {
    ...
    writeFileSync(input, JSON.stringify({ binding, fixturePayload: fixture.payload, invocation: { targetPath, targetSourceSha256: hashes.target, exportName: "executeWave9RankChain" } }));
    ...
    const payload: Omit<ObjectDbConsumerExecutionReceipt, "receiptSha256"> = {
      receiptId: `receipt:wave9:${binding.consumerId}:${binding.scenarioKind.toLowerCase()}`,
